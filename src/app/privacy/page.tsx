    ...
    <div className="max-w-3xl mx-auto px-4 py-10">
      ...
      <div className="prose prose-sm max-w-none space-y-4 text-sm leading-relaxed text-foreground/80">
        ...
        <p>
          ...
          Email используется для отправки PDF-отчёта по заказанной услуге,
          а также для информирования о связанных услугах сервиса
          (консультации, акции, новости платформы).
          Вы можете отписаться от информационных писем в любой момент
          по ссылке внизу любого письма или написав на{" "}
