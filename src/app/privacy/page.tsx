        ...
        <div className="mx-auto max-w-3xl px-4 py-10">
          ...
          <Section n={5} title="Кому мы передаём данные">
            ...
            <ul className="ml-5 list-disc space-y-1.5">
              ...
              <li>
                ...
                посещаемость и источники переходов. На страницах с результатами анализа и в чатах о
                здоровье запись сессии (вебвизор) и карта кликов выключены: содержимое этих страниц
                в Метрику не передаётся. В демонстрационном разделе счётчик не загружается вовсе.
              </li>
            </ul>
            <p>
          ...
          <Section n={10} title="Файлы cookie и аналитика">
            <p>
              ...
              посещаемости. На страницах, где показан ваш разбор анализа, и в чатах о здоровье
              запись сессии отключена — Метрика не получает содержимое этих страниц. Отключить
              аналитику целиком можно настройками браузера или блокировщиком; на работу сервиса
              это не влияет.
            </p>
          </Section>
