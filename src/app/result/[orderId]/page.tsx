  ...
  if (status.payment_status === "failed") {
    return (
      <div className="max-w-2xl mx-auto px-4 py-16 text-center">
        ...
        <a
          href="/"
          className="inline-block py-3 px-8 rounded-xl bg-primary text-white font-semibold hover:bg-primary-dark transition"
        >
          Попробовать снова
        </a>
      </div>
  ...
  if (status.processing_status === "processing" || status.processing_status === "not_started") {
    return (
      <div className="max-w-2xl mx-auto px-4 py-16 text-center">
        ...
        <div className="mt-6 w-64 mx-auto h-2 bg-border rounded-full overflow-hidden">
  ...
  if (status.processing_status === "completed") {
    return (
      <div className="max-w-2xl mx-auto px-4 py-16 text-center">
        ...
        <h1 className="text-xl font-semibold">Ваш отчёт готов!</h1>
        ...
        {status.pdf_download_url && (
          <a
            ...
            download
            className="mt-6 inline-flex items-center gap-2 py-3 px-8 rounded-xl bg-primary text-white font-semibold hover:bg-primary-dark transition"
          >
