  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-10">
      ...
      <div className="prose prose-sm max-w-none space-y-4 text-sm leading-relaxed text-foreground/80">
        ...
        <h2 className="text-lg font-semibold mt-6">4. Возврат по годовому абонементу</h2>
        <p>
          Для услуги «Годовой абонемент» (799 ₽, 10 расшифровок на 12 месяцев)
          действуют отдельные условия:
        </p>
        <ul className="list-disc pl-5 space-y-1">
          <li>
            <strong>Полный возврат</strong> — в течение 14 календарных дней с
            даты оплаты, при условии, что не использована ни одна расшифровка
            из абонемента (10 из 10 доступны).
          </li>
          <li>
            <strong>После первого использования</strong> — возврат не
            предусмотрен. Абонемент считается частично оказанной услугой,
            оставшиеся расшифровки доступны до конца 12-месячного срока.
          </li>
          <li>
            <strong>По истечении 12 месяцев</strong> — неиспользованные
            расшифровки сгорают и возврату не подлежат.
          </li>
        </ul>
        <p>
          Для оформления возврата по абонементу — те же шаги, что в разделе
          «Порядок обращения за возвратом» выше.
        </p>
