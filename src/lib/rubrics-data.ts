...
export const rubrics: Rubric[] = [
  ...
  {
    slug: "deti",
    title: "Анализы у детей",
    description:
      "Как читать детский бланк: почему у ребёнка «свои» нормы и они меняются с возрастом, " +
      "что смотрят в год, перед садиком и школой, и когда отклонение — вариант нормы роста.",
    categories: ["Дети"],
  },
  {
    slug: "mocha-i-kal",
    title: "Анализы мочи и кала",
    description:
      "Как читать бланк общего анализа мочи и копрограммы: что значат лейкоциты, эритроциты, " +
      "соли и эпителий, когда отклонение — следствие неправильного сбора, а когда повод проверяться.",
    categories: ["Анализы мочи", "Анализы кала"],
  },
  {
    slug: "chekapy",
    title: "Чекапы",
