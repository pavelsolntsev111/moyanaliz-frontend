...
const faqItems = [
  ...
  },
  {
    ...
    a: "Полная расшифровка одного бланка — 299 ₽, разовый платёж, без подписки и автосписаний. Предварительный результат по двум показателям бесплатный: вы платите, только если решили открыть отчёт целиком. В отчёт входят разбор всех распознанных показателей, отдельный блок по отклонениям от референсов, общие рекомендации по питанию и образу жизни, список вопросов врачу и PDF на почту. Дороже стоят вариант с чат-консультантом (349 ₽) и наборы отчётов (от 449 ₽) — в наборе один разбор обходится дешевле.",
  },
  {
