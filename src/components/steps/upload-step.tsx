...
const faqItems = [
  ...
  },
  {
    ...
    a: "Предварительный результат появляется сразу после загрузки — за 30 секунд. Полный отчёт с детальными рекомендациями формируется обычно за 1–2 минуты после оплаты, иногда дольше при объёмных анализах.",
  },
  {
